...
plt.rcParams['ytick.labelsize'] = 25  # Font size for y-axis tick labels
...
def plot_waveform():
    ...
    try:
        ...
        axs[0].set_title('Filtered MiniSEED Waveform')
